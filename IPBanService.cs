...
";
        ...
        private void ProcessXml(string xml)
        {
            ...
            {
                // Log the event.
                XmlNode eventIdNode = doc.SelectSingleNode("//EventID");
                if (eventIdNode != null)
                {
                    Log.Write(LogLevel.Info, "Processing Event ID {0}", eventIdNode.InnerText);
                }
                ...
                {
                    // Process the failed login attempt.
